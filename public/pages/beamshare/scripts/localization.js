class Localization {
    ...
    static async fetchTranslationsFor(newLocale) {
        ...
        if (!response || !response.ok) {
            console.warn('Failed to load translations for locale', newLocale, 'Response:', response);
            return false;
        }
        ...
        try {
            ...
            console.error('Failed to parse translation file for locale', newLocale, error);
            return false;
        }
    }
    ...
    static logHelpCall() {
        console.log("Help translating BeamShare: https://hosted.weblate.org/engage/pairdrop/");
    }
