import { parser as b } from "../../../../../@lezer_css@1.1.9/node_modules/@lezer/css/dist/index.mjs";
import { LRLanguage as w, indentNodeProp as v, continuedIndent as y, foldNodeProp as k, foldInside as x, LanguageSupport as z, syntaxTree as S } from "../../../../../@codemirror_language@6.10.2/node_modules/@codemirror/language/dist/index.mjs";
import { IterMode as q, NodeWeakMap as C } from "../../../../../@lezer_common@1.2.1/node_modules/@lezer/common/dist/index.mjs";
let c = null;
function u() {
  if (!c && typeof document == "object" && document.body) {
    ...
    c = a.sort().map((r) => ({ type: "property", label: r }));
  }
  return c || [];
}
const p = /* @__PURE__ */ [
...
const f = /* @__PURE__ */ new C(), P = ["Declaration"];
function T(t) {
  for (let a = t; ; ) {
    if (a.type.isTop)
      return a;
...
function h(t, a, o) {
  if (a.to - a.from > 4096) {
    ...
    if (r)
      return r;
    let e = [], l = /* @__PURE__ */ new Set(), i = a.cursor(q.IncludeAnonymous);
    if (i.firstChild())
      do
...
}, I = /* @__PURE__ */ B((t) => t.name == "VariableName"), g = /* @__PURE__ */ w.define({
  name: "css",
...
function j() {
  return new z(g, g.data.of({ autocomplete: I }));
}
export {
  j as css,
