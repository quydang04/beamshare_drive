import { ExternalTokenizer as r, LRParser as c, LocalTokenGroup as d } from "../../../../../@lezer_lr@1.4.2/node_modules/@lezer/lr/dist/index.mjs";
import { styleTags as y, tags as e } from "../../../../../@lezer_highlight@1.2.1/node_modules/@lezer/highlight/dist/index.mjs";
const p = 99, P = 1, m = 100, g = 101, n = 2, s = [
  9,
  10,
  11,
  12,
  ...
  8287,
  12288
], f = 58, T = 40, i = 95, R = 91, t = 45, W = 46, z = 35, U = 37, h = 38, b = 92, Y = 10;
function S(O) {
...
const u = new r((O, Q) => {
  for (let o = !1, l = 0, $ = 0; ; $++) {
    let { next: a } = O;
    if (S(a) || a == t || a == i || o && X(a))
      !o && (a != t || $ > 0) && (o = !0), l === $ && a == t && l++, O.advance();
    else if (a == b && O.peek(1) != Y)
      O.advance(), O.next > -1 && O.advance(), o = !0;
    else {
      o && O.acceptToken(a == T ? m : l == 2 && Q.canShift(n) ? n : g);
      break;
    }
  }
}), G = new r((O) => {
  if (s.includes(O.peek(-1))) {
    let { next: Q } = O;
    (S(Q) || Q == i || Q == z || Q == W || Q == R || Q == f && S(O.peek(1)) || Q == t || Q == h) && O.acceptToken(p);
  }
}), E = new r((O) => {
  if (!s.includes(O.peek(-1))) {
    let { next: Q } = O;
    if (Q == U && (O.advance(), O.acceptToken(P)), S(Q)) {
      do
        O.advance();
      while (S(O.next) || X(O.next));
      O.acceptToken(P);
    }
  }
}), Z = y({
  ...
  "[ ]": e.squareBracket,
  "{ }": e.brace
}), V = { __proto__: null, lang: 32, "nth-child": 32, "nth-last-child": 32, "nth-of-type": 32, "nth-last-of-type": 32, dir: 32, "host-context": 32, url: 60, "url-prefix": 60, domain: 60, regexp: 60, selector: 138 }, _ = { __proto__: null, "@import": 118, "@media": 142, "@charset": 146, "@namespace": 150, "@keyframes": 156, "@supports": 168 }, w = { __proto__: null, not: 132, only: 132 }, x = c.deserialize({
  version: 14,
  ...
  tokenizers: [G, E, u, 1, 2, 3, 4, new d("m~RRYZ[z{a~~g~aO#^~~dP!P!Qg~lO#_~~", 28, 105)],
  topRules: { StyleSheet: [0, 4], Styles: [1, 86] },
  specialized: [{ term: 100, get: (O) => V[O] || -1 }, { term: 58, get: (O) => _[O] || -1 }, { term: 101, get: (O) => w[O] || -1 }],
  tokenPrec: 1219
});
export {
  x as parser
