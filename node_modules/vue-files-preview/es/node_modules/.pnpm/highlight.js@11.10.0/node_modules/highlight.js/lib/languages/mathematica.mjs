...
function x() {
  ...
  function r(t) {
    const e = t.regex, l = /([2-9]|[1-2]\d|[3][0-5])\^\^/, s = /(\w*\.\w+|\w+\.\w*|\w+)/, c = /(\d*\.\d+|\d+\.\d*|\d+)/, u = e.either(e.concat(l, s), c), m = /``[+-]?(\d*\.\d+|\d+\.\d*|\d+)/, d = /`([+-]?(\d*\.\d+|\d+\.\d*|\d+))?/, p = e.either(m, d), S = /\*\^[+-]?\d+/, g = {
      className: "number",
      relevance: 0,
      begin: e.concat(
        u,
    ...
    }, i = /[a-zA-Z$][a-zA-Z0-9$]*/, C = new Set(n), D = { variants: [
      {
        className: "builtin-symbol",
        begin: i,
        // for performance out of fear of regex.either(...Mathematica.SYSTEM_SYMBOLS)
        "on:begin": (R, M) => {
          C.has(R[0]) || M.ignoreMatch();
        }
      },
      {
        className: "symbol",
...
//# sourceMappingURL=mathematica.mjs.map
