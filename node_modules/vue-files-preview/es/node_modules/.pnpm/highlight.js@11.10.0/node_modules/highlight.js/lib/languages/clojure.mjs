...
function E() {
  ...
  b = 1;
  function g(t) {
    const i = "a-zA-Z_\\-!.?+*=<>&'", e = "[#]?[" + i + "][" + i + "0-9/;:$#]*", n = "def defonce defprotocol defstruct defmulti defmethod defn- defn defmacro deftype defrecord", v = {
      $pattern: e,
      built_in: (
        // Clojure keywords
    ...
    }, u = t.inherit(t.QUOTE_STRING_MODE, { illegal: null }), p = {
      scope: "punctuation",
      match: /,/,
      relevance: 0
    }, f = t.COMMENT(
